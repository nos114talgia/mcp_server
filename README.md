...
| 文档 | 说明 |
|------|------|
| [StreamableHTTP技术实现文档.md](StreamableHTTP技术实现文档.md) | Streamable HTTP 传输层的架构设计与实现细节 |
| [StreamableHTTP测试文档.md](StreamableHTTP测试文档.md) | 使用 curl 测试 Streamable HTTP 的完整用例 |
| [热插拔技术文档.md](热插拔技术文档.md) | 插件热插拔机制的设计文档 |
...
> **Streamable HTTP** 是 MCP 2025-03-26 规范推荐的传输方式，支持根据客户端 `Accept` 头动态切换 JSON 响应和 SSE 流式响应。详见 [StreamableHTTP技术实现文档.md](StreamableHTTP技术实现文档.md)。
...
完整测试用例参见 [StreamableHTTP测试文档.md](StreamableHTTP测试文档.md)。
